...
var TextToSpeechV1 = /** @class */ (function (_super) {
    ...
    TextToSpeechV1.prototype.createVoiceModel = function (params, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var sdkHeaders = common_1.getSdkHeaders(TextToSpeechV1.DEFAULT_SERVICE_NAME, 'v1', 'createVoiceModel');
            var parameters = {
                options: {
    ...
    TextToSpeechV1.prototype.listVoiceModels = function (params, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var sdkHeaders = common_1.getSdkHeaders(TextToSpeechV1.DEFAULT_SERVICE_NAME, 'v1', 'listVoiceModels');
            var parameters = {
                options: {
                    url: '/v1/customizations',
                    method: 'GET',
    ...
    TextToSpeechV1.prototype.updateVoiceModel = function (params, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var sdkHeaders = common_1.getSdkHeaders(TextToSpeechV1.DEFAULT_SERVICE_NAME, 'v1', 'updateVoiceModel');
            var parameters = {
                options: {
    ...
    TextToSpeechV1.prototype.getVoiceModel = function (params, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var sdkHeaders = common_1.getSdkHeaders(TextToSpeechV1.DEFAULT_SERVICE_NAME, 'v1', 'getVoiceModel');
            var parameters = {
                options: {
                    url: '/v1/customizations/{customization_id}',
                    method: 'GET',
    ...
    TextToSpeechV1.prototype.deleteVoiceModel = function (params, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var sdkHeaders = common_1.getSdkHeaders(TextToSpeechV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteVoiceModel');
            var parameters = {
                options: {
                    url: '/v1/customizations/{customization_id}',
                    method: 'DELETE',
    ...
    ;
    TextToSpeechV1.DEFAULT_SERVICE_URL = 'https://stream.watsonplatform.net/text-to-speech/api';
